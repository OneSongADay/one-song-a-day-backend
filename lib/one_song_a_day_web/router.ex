defmodule OneSongADayWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {OneSongADayWeb.LayoutView, :root}
  ...
  scope "/", OneSongADayWeb do
    ...
    live "/live_songs/released", LiveSongLive.Released, :released

    live "/live_songs/:id/edit", LiveSongLive.Index, :edit

    live "/live_songs/:id", LiveSongLive.Show, :show
    live "/live_songs/:id/show/edit", LiveSongLive.Show, :edit
  end

  # Other scopes may use custom stacks.
  # scope "/api", OneSongADayWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: OneSongADayWeb.Telemetry
    end
  end
